    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-gradient-to-r from-red-500 to-orange-500 h-2 rounded-full transition-all duration-300" style={{ width: `${Math.floor(Math.random() * 50) + 20}%` }}></div>
                  </div>
                </div>

                {/* Add to Cart Button */}
                <button className="w-full py-3 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-pulse-glow">
                  Grab This Deal
                </button>
              </div>
        ...
        <div className="text-center mt-12">
          <button className="px-8 py-4 bg-white border-2 border-red-600 text-red-600 font-semibold rounded-xl hover:bg-red-600 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl">
